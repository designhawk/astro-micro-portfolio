...
In the rapidly evolving field of robotics, Peer Robotics stands at the forefront of developing collaborative robots for manufacturing and warehousing environments. As the company's technology advanced, the need for a digital presence that could effectively communicate their innovative solutions to a global audience became apparent.[^1]
...
![Collaborative Robot in Action](https://circuitdigest.com/sites/default/files/inlineimages/u3/Peer-Robotics-Services.jpg)
*A Peer Robotics collaborative robot working alongside human operators in a manufacturing setting*

![Peer Robotics Co-founders](https://cms-article.forbesindia.com/media/images/2023/Feb/img_202933_peerroboticscofounders.jpg)
*Rishabh Agarwal, Alok Kumar, and Tanya Raghuvanshi, co-founders at Peer Robotics*
...
![Moodboard](https://images.prismic.io/designhawk/ZqEw-x5LeNNTxd7W_Screenshot2024-02-02at12.175-1-.png?auto=format,compress)
*Moodboard for the website and brand*
...
![Notes Widget](https://images.prismic.io/designhawk/ZqD1Qx5LeNNTxdQJ_Slide4_3-1-1-.png?auto=format,compress)
*I generally use widgets for adding notes on a particular section*

- Created concepts incorporating Peer Robotics' brand colours, typography, and visual elements.

![Early Concepts](https://images.prismic.io/designhawk/ZqEuzB5LeNNTxd6L_image90.png?auto=format,compress)
*Early concepts that I was working on*

![Concrete Concepts](https://images.prismic.io/designhawk/ZqEuzR5LeNNTxd6M_image91.png?auto=format,compress)
*Working on concrete concepts after a basic idea of composition and brand*

### 3. Development and Testing

- Developed the website using Webflow, employing Finsweet-based practices for better management of classes and overall website handling in terms of the backend.[^2]
- Performed extensive cross-browser and device testing to ensure a consistent experience across platforms.
- Implemented scripts like Lenis for smoother overall scrolling, and used Splide, Swiper, and Lottie files for enhanced interactivity.

![Lighthouse Report](https://images.prismic.io/designhawk/ZqEuPh5LeNNTxd55_Screenshot2024-07-24220429.png?auto=format,compress)
*Lighthouse Report showing performance metrics*
...
![Macbook Mockup 2](https://images.prismic.io/designhawk/ZqE76h5LeNNTxd_d_MACBOOK-MOCKUP-06copy-1-.png?auto=format,compress)

![iPhone Mockup 2](https://images.prismic.io/designhawk/ZqE77R5LeNNTxd_f_IPHONE-MOCKUP-03copy-1-.png?auto=format,compress)
...
- **Mobile Traffic**: Mobile users increased by 20%, with mobile conversion rates improving by 120%.[^3]

## Learnings

1. **Visualization is Key**

![Visualization Meme](https://images.prismic.io/designhawk/ZqDqIB5LeNNTxdJK_download.jpeg?auto=format,compress)
*In the robotics industry, showing is more effective than telling.*
...
[^2]: Finsweet practices in Webflow development include using global classes, creating reusable components, and optimizing for performance.
[^3]: The significant improvement in mobile conversion rates underscores the importance of mobile-first design in modern web development.
